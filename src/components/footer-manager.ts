...
import type { FluxPanelsSettings, FooterRuntimeState } from "../types/settings";
...
export class FooterManager {
	...
	constructor(
		...
		private getSettings: () => FluxPanelsSettings
	) {}
	...
	private getContentForCurrentFile(): string | null {
		...
		for (const mapping of settings.footerDirectoryMappings) {
